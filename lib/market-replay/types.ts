...
export const MARKET_BAR_BLOCK_SIZES = [64, 512, MARKET_BAR_BLOCK_SIZE] as const;
export const REPLAY_HISTORY_BARS = 200;
export const REPLAY_INITIAL_VISIBLE_BARS = 300;
export const REPLAY_HISTORY_BAR_LIMIT = 25_000;
export const REPLAY_HISTORY_COMPACT_TO = 24_000;
export const REPLAY_HISTORY_PAGE_LIMIT = 2_000;
export const REPLAY_HISTORY_PREFETCH_THRESHOLD = 300;
export const REPLAY_HISTORY_RAW_SOURCE_BUDGET = 25_000;
...
export const MARKET_DISPLAY_CACHE_BUDGET_BYTES = 64 * 1024 * 1024;
